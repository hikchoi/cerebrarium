(function (jtd, undefined) {
    ...
    function initNavBar() {
      return fetch("https://cerebrarium.garden/nav.html").then(function (response) {
    ...
    function initSearch() {
      ...
      request.open("GET", "https://cerebrarium.garden/assets/js/search-data.json", true);
    ...
    jtd.setTheme = function (theme) {
      ...
      cssFile.setAttribute(
        "href",
        'https://cerebrarium.garden/assets/css/just-the-docs-' + theme + ".css"
      );
    };
